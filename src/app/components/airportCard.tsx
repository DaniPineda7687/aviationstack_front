...
const AirportCard: React.FC<AirportCardProps> = ({ airport }) => {
  return (
    <div className="cursor-pointer relative rounded-lg shadow-md border border-white overflow-hidden p-8 transition-all duration-300 hover:brightness-70 hover:shadow-xl">
